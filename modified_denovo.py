#########################################################
## Modified DNV calling function
#########################################################

## Source: https://discuss.hail.is/t/de-novo-calls-on-hemizygous-x-variants/2357/20 posted by Kyle Satterstrom
from hail import *
...
def modified_denovo(mt: MatrixTable,
            pedigree: Pedigree,
            pop_frequency_prior,
            *,
            min_gq: int = 20,
